...
module.exports.promisify = function(callback){
  console.log("inside of promisify, this is ", this);
  var that = this;
  return function(){
    var deferred = defer();
    ...
    deferred.promise.value = callback.apply(that, args);
